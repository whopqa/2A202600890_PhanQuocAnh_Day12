"""Legal retrieval specialist service for the Day 8 A2A runtime."""
...
def answer_question(question: str, trace_id: str | None = None) -> str:
    payload = build_specialist_response(question, domain="legal", top_k=4)
    if trace_id:
        append_trace(
            trace_id=trace_id,
            stage="stage4",
            ...
            status="completed",
            detail="Legal specialist da retrieval va tong hop bang chung.",
            metadata={
